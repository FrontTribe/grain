    ...
    <div className="min-h-screen bg-ground text-ink">
      ...
      <main className="mx-auto max-w-[820px] px-6 py-10">
        ...
        <p className="mb-7 mt-2 max-w-[62ch] text-[14.5px] leading-relaxed text-muted">
          A grain authorship Bill of Materials is signed with a SHA-256 digest of its own contents.
          Paste a report below and this page recomputes that digest in your browser — nothing is uploaded —
          to confirm the human-vs-AI figures are exactly as grain generated them.
        </p>
        ...
        <p className="mt-8 text-[12.5px] text-faint">
          ...
          Verification runs entirely client-side; the report never leaves your device.
        </p>
      </main>
    </div>
  );
