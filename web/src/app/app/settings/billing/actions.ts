...
export async function openPortal() {
  ...
  if (!orgId) redirect("/app/settings?billing=error");
  ...
  if (!customerId) redirect("/app/settings?billing=error");
