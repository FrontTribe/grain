...
Run [Grain](https://github.com/FrontTribe/grain) — the code-provenance CLI —
...
Prefer a native install? `go install github.com/FrontTribe/grain/cmd/grain@latest`,
Homebrew, or a release binary — see the [main README](https://github.com/FrontTribe/grain).
